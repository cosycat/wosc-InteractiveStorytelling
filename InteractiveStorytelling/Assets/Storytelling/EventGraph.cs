...
namespace Storytelling {
    ...
    public class EventGraph {
        ...
        public HashSet<NPC> C => e.AtomicStoryElements.Select(element => element.Character).ToHashSet();
        public HashSet<Item> I => new HashSet<Item>(); // TODO get items needed for activity.
        /// <summary>
        ...
        public EventGraph(EventFrame eventFrame, IEnumerable<AtomicStoryElement> atomicStoryElements) {
            e = eventFrame;
            S = SpatialGraph.CreateAllSpatialGraphs(this);
        }
    }
